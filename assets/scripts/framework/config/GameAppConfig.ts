...
export default class GameAppConfig {
    ...
    static REMOTE_WECHAT_PORT       = "5081";                       // 小程序wss端口，nginx配置6081,转发到6061
    static NATIVE_PLATFORM_PORT     = "5061";                       // 安卓IOS原生平台端口,直接连接到5081
    static PROTO_TYPE               = ProtoManater.PROTO_BUF;   
    static REMORE_HTTP_HOT_PORT     = "5000";                       // http 热更新端口
    static REMORE_HTTP_CONFIG_PORT  = "5070";                       // http 配置端口
