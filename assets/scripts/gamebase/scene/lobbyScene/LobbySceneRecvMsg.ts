...
export default class LobbySceneRecvMsg extends UIController {
    ...
    add_cmd_handler_map(){
        this._cmd_handler_map = {
            ...
            [LobbyProto.XY_ID.RES_GAMEINFO]: this.on_event_ugame_info.bind(this),
            ...
            if(status == Response.SUCCESS){
                ...
                if(matchsuccess == true){
                    ...
                    this.scheduleOnce(function(dt:number){
                        DialogManager.getInstance().close_layer("MatchDialog");
                ...
                if(!matchsuccess && userinfo){
                    let matchDialog = DialogManager.getInstance().get_layer("MatchDialog");
                    if (matchDialog && cc.isValid(matchDialog)){
                        ...
                        let resNode: cc.Node = DialogManager.getInstance().show_poplayer("MatchDialog");
